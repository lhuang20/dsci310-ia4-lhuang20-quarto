...
![Horse populations for all provinces in Canada from 1906 - 1972](../results/horse_pops_plot.png){#fig-horses_1 width=100%}

We can see from @fig-horses_1 that Ontario, Saskatchewan and Alberta 
...
We present the standard deviations in @tbl-horses_1.
...
Additionally, note that in @tbl-horses_1 we consider the sample standard deviation of the number of horses during the same time span as @fig-horses_1.

![Horse populations for the province with the largest standard deviation](../results/horse_pop_plot_largest_sd.png){#fig-horses_2 width=60%}

In @fig-horses_2 we zoom in and look at the province of `{r} largest_sd`, which had the largest spread of values in terms of standard deviation.
